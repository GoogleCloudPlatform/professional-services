...
* [Automating Cloud DNS for VM Instances](tools/automated-dns-for-instances) - A cloud function that creates/updates/deletes Cloud DNS records for VM instances.
