...
* [BigQuery Automated Email Exports](examples/bq-email-exports) - Solution to automate the sending of BigQuery export results via email on a scheduled interval. The email will contain a link to a signed URL, allowing the recipient to view query results as a CSV.
