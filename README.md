...
* [IP Range Monitor](tools/ip-range-monitor) - An Apps Script project that will automatically provide email or Chat notifications when changes are made to Google’s IP prefixes.
