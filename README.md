...
*   [BigQuery Remote Function](examples/bq-remote-function) - It allows user to implement their custom
    libraries or services in languages other than SQL or Javascript which are not part og UDFs.
    The utility contains sample Java code to deploy cloud run gen2 instance and invoke the service 
    from biguery using remote function.
