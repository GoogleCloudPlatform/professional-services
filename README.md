...
* [Dataflow Hashpipeline](examples/dataflow-hashpipeline) - Use a Cloud Function to trigger a templetized Dataflow job that matches Social Security Number findings from DLP against a hashed and keyed Firestore database and outputs the number of valid SSNs to Pubsub. Terraform included.
