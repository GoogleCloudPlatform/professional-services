...
* [GCE Delete New Instance w/o CMEK](tools/gce-delete-if-not-cmek) - A Cloud Function that deletes newly created VM Instances with attached disks that do not use customer-managed encryption keys.
