...
* [Automating Cloud DNS for VM Instances](toos/automated-dns-for-instances) - A cloud function that creates/updates/deletes Cloud DNS records for VM instances.
