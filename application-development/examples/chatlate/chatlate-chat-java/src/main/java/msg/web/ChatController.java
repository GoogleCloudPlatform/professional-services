...
public class ChatController {
    ...
    @RequestMapping(value = "/message/{recipient}/{language}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Messages getMessages(@PathVariable String recipient, @PathVariable String language) throws Exception {
        List<Message> messageList = spannerService.getMessages(recipient).stream().map(m -> {
    ...
    public Messages getMessagesWithHeaders(@RequestHeader(value = "Chat-Recipient") String recipient, @RequestHeader(value = "Chat-Language") String language) throws Exception {
        //This is a delegate method to make the signatures easier to match in the load test
        return getMessages(recipient, language);
    }


    @RequestMapping(value = "/login/{recipient}/{language}", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public Status login(@PathVariable String recipient, @PathVariable String language) throws Exception {
        Status status = new Status();
        status.result = "Ok";
        return status;
    }
    ...
    public Status loginWithHeaders(@RequestHeader(value = "Chat-Recipient") String recipient, @RequestHeader(value = "Chat-Language") String language) throws Exception {
        //This is a delegate method to make the signatures easier to match in the load test
        return login(recipient, language);
    }


    @RequestMapping(value = "/history/{recipient}/{language}/{sender}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Messages getHistory(@PathVariable String recipient, @PathVariable String language, @PathVariable String sender) throws Exception {
    ...
    public Messages getHistoryWithHeaders(@RequestHeader(value = "Chat-Recipient") String recipient,
                                          @RequestHeader(value = "Chat-Language") String language,
                                          @RequestHeader(value = "Chat-Sender") String sender) throws Exception {
        //This is a delegate method to make the signatures easier to match in the load test
