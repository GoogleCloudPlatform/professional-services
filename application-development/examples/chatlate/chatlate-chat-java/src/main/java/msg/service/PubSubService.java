...
public class PubSubService {
    ...
    public void createSubscription(String topicId, String subscriptionId) throws Exception {
        ...
        try (SubscriptionAdminClient subscriptionAdminClient = SubscriptionAdminClient.create()) {
            ...
            SubscriptionName subscriptionName =
                    SubscriptionName.create(PROJECT_ID, subscriptionId);
    ...
    public Subscriber getMessages(String subscriptionId, MessageReceiver messageReceiver) throws Exception {
        SubscriptionName subscriptionName = SubscriptionName.create(PROJECT_ID, subscriptionId);
        Subscriber subscriber = null;

        // create a subscriber bound to the asynchronous message receiver
        subscriber =
                Subscriber.defaultBuilder(subscriptionName, messageReceiver)
                        .build();
    ...
    public List<Message> getMessagesSync(String subscriptionId, int maxNumOfMessages) throws Exception {
        ...
        try (SubscriberStub subscriber = GrpcSubscriberStub.create(subscriptionAdminSettings)) {
            ...
            pullResponse.getReceivedMessagesList().stream().forEach(m -> {
