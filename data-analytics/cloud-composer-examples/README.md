...
<img src="img/workflow-overview.png" alt="Workflow Overview" height="400" width="800"/>
...
The workflow then executes a [Cloud Dataflow job](composer_dataflow_examples/src/process_delimited.py) to process the delimited file, adds filename and load_dt fields and loads the data into a Cloud BigQuery table.

##### 3. Move to processed bucket

<img src="img/sample-dag.png" alt="DAG Overview" height="150" width="300"/>
...
8. Upload the Python Dataflow code [process_delimited.py](composer_dataflow_examples/src/process_delimited.py) into a *src* folder created in the base DAG folder.
