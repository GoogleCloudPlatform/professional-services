...
# Deploy the AutoML Tables model for online prediction.
#
# Usage: bash deploy_model.sh config_file.yaml
#
# Deploys the AutoML model for online prediction.
...
# operation-name with the name from the deployment request:
# curl -X GET \
...
-d "" \
https://automl.googleapis.com/v1beta1/projects/${PROJECT_ID}/locations/${REGION}/models/${MODEL_ID}:deploy
