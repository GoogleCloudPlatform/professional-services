...
gcs_update_delete_output_path = f"gs://{gcs_bucket_name}/scd/{batch_id}/output_update_delete.csv"
gcs_insert_output_path = f"gs://{gcs_bucket_name}/scd/{batch_id}/output_insert_scd.csv"


# Call the function with your variables
export_bigquery_to_gcs(settings.PROJECT_ID, settings.BQ_INPUT_TABLE_NAME, gcs_input_path)
