...
public class ScanProject implements BackgroundFunction<PubSubMessage> {
  ...
  private static void getProjectRegionalQuota(
      GCPResourceClient gcpResourceClient, String projectId, String orgId) throws IOException {
   ...
   * */
  private static void loadBigQuery(
    ...
    ProjectQuota projectQuota =
        populateProjectQuota(quota, network, vpcSubnet, orgId, projectId, regionId);
