...
def firestore_write(collection, content) -> str:
    """
    Takes the provided json and attaches a guid and timestamp to it and then writes
    it to the specified collection.
...
if __name__ == "__main__":
    ...
    resource_name = 'projects/{}/cases/{}'.format(project_number, case)
    content = {
              "case_number": case,
    ...
    collection = 'cases'
    print(str(firestore_write(collection, content)))
