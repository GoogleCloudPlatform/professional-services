...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Name of the key ring containing the key to encrypt the disks. Must be in the same region as the instance or global.'
    )
    parser.add_argument(
        '--key-name',
        required=True,
        ...
        type=str,
        help=
        'Name of the key to encrypt the disks. Must be in the same region as the instance or global.'
    )
    ...
    parser.add_argument('--key-global',
                        dest='key_global',
                        action='store_true',
                        default=False,
