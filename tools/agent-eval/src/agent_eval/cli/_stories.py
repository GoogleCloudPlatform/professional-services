...
STORIES: list[tuple[str, str]] = [
    ...
    (
        ...
        "So when agent-eval generate (or simulate) detects non-empty [cyan]criteria[/] in "
    ...
    (
        ...
        "All three converge at [cyan]agent-eval grade[/] (or [cyan]evaluate[/]). The evaluator "
    ...
    (
        ...
        "and the [cyan]agent-eval generate --mode live[/] (or [cyan]interact[/]) phase. Zero deployment "
