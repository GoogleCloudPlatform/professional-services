...
class QuantitativeAnalyzer:
    ...
    def anova_one_way(self, anova_df: pd.DataFrame) -> float:
    ...
    def chi_square(self, chi_square_df: pd.DataFrame) -> float:
    ...
    def information_gain(self, ig_df: pd.DataFrame) -> float:
    ...
    def pearson_correlation(self, corr_df: pd.DataFrame) -> Dict:
