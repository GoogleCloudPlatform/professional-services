...
def create_analysis_proto_from_scalar_metrics(analysis_name: str,
                                              attributes: List[
                                                  run_metadata_pb2.Attribute],
...
def create_analysis_proto_from_table_metric(analysis_name: str,
                                            attributes: List[
                                                run_metadata_pb2.Attribute],
                                            metric_names: List[str],
