...
class QualitativeAnalysis:
    ...
    def _run_single_contingency_table(
        ...
        return utils.create_analysis_proto_from_table_metric(
            analysis_name=run_metadata_pb2.Analysis.CONTINGENCY_TABLE,
            attributes=[categorical_attribute_one, categorical_attribute_two],
            metric_names=[run_metadata_pb2.TableMetric.CONTINGENCY_TABLE],
            metric_dfs=[
    ...
    def _run_single_categorical_numerical_descrip(
        ...
        descrip_df = self._data_extractor.extract_numerical_descrip_categorical_data(
        ...
        return utils.create_analysis_proto_from_table_metric(
            analysis_name=run_metadata_pb2.Analysis.TABLE_DESCRIPTIVE,
            attributes=[numerical_attribute, categorical_attribute],
            metric_names=[run_metadata_pb2.TableMetric.TABLE_DESCRIPTIVE],
            metric_dfs=[descrip_df.set_index(categorical_column)]
        )

    def run_contigency_table(self):
    ...
    def run_categorical_numerical_descriptive(self):
        categorical_features = self._data_def.low_card_categorical_attributes
