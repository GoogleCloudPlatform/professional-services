...
class MetadataDef:
    ...
    def _create_attributes(self, attribute_names, attribute_type):
        return [
            run_metadata_pb2.Attribute(name=name, type=attribute_type)
            for name in attribute_names
        ]

    def _create_numerical_attributes(self, attribute_names):
        return self._create_attributes(attribute_names,
                                       run_metadata_pb2.Attribute.NUMERICAL)

    def _create_categorical_attributes(self, attribute_names):
        return self._create_attributes(attribute_names,
