...
from ml_eda.reporting import report_template
...
REPORT_STRUCTURE = (
    ...
    ('title', report_template.REPORT_TITLE,
     "Exploratory Data Analysis Report", False),

    ('dataset_info', None, None, True),

    ('descriptive', report_template.SECTION_TITLE,
     "Descriptive Analysis", True),

    ('correlation_analysis', report_template.SECTION_TITLE,
     'Correlation Analysis between attributes', True),

    ('correlation_numerical', report_template.SUB_SECTION_TITLE,
     "Correlation between numerical attributes", True),

    ('correlation_categorical', report_template.SUB_SECTION_TITLE,
     "Correlation between categorical attributes", True),

    ('correlation_numerical_categorical', report_template.SUB_SECTION_TITLE,
     "Correlation between categorical and numerical attributes", True),

    ('target_highlight', report_template.SECTION_TITLE,
     'Correlation highlight between features and target', True),

    ('summary', report_template.SECTION_TITLE,
     'Summary', False),

    ('warning', report_template.SUB_SECTION_TITLE,
     'Warnings', True),

    ('recommend', report_template.SUB_SECTION_TITLE,
...
def create_descriptive_section(
    ...
    section_template = report_template.TABLE_DESCRIPTIVE_TEMPLATE
...
def create_contingency_table_section(analysis_tracker: AnalysisTracker
    ...
    if analysis_results:
        ...
        for analysis in analysis_results:
            ...
            section_title = report_template.SUB_SUB_SUB_SECTION_TITLE.format(
...
def create_dataset_info_section(analysis_tracker: AnalysisTracker
    ...
    return report_template.DATASET_INFO_TEMPLATE.format(
...
def create_target_highlight_section(analysis_tracker: AnalysisTracker
    ...
    """Create the section highligh the correlation analysis performed between
    ...
    if ml_problem == c.metadata.ml_type.NULL:
        ...
        if r_numerical_metrics:
            section_content.append(report_template.SUB_SUB_SECTION_TITLE.format(
...
def create_report_contents(analysis_tracker: AnalysisTracker,
    ...
    if corr_result is not None:
        ...
        corr_section_title = report_template.SUB_SUB_SECTION_TITLE.format(
    ...
    if contingency_content is not None:
        contingency_section_title = report_template.SUB_SUB_SECTION_TITLE.format(
    ...
    if info_content is not None:
        info_section_title = report_template.SUB_SUB_SECTION_TITLE.format(
    ...
    if chi_square_result is not None:
        ...
        chi_square_section_title = report_template.SUB_SUB_SECTION_TITLE.format(
    ...
    if table_descriptive_content is not None:
        dt_section_title = report_template.SUB_SUB_SECTION_TITLE.format(
    ...
    if anova_result is not None:
        ...
        anova_section_title = report_template.SUB_SUB_SECTION_TITLE.format(
