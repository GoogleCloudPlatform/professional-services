...
def main_handler(request):
    ...
    try:
        ...
        print(
            f"Initializing Vertex AI for project '{project_id}' in location '{location}' with model '{model_id}'..."
        )
        ...
        print(
            f"Listing files in gs://{read_bucket_name}/{list_prefix} with filter: {file_extension_filter}"
        )
