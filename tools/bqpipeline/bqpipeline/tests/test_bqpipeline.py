...
class TestQueryParameters(unittest.TestCase):
    def test_tablespec_resolution(self):
        ...
        self.assertEqual(bq.resolve_ts('testtable'), 'testproject.testdataset.testtable')
        # resolve from dataset.table
        self.assertEqual(bq.resolve_ts('testdataset.testtable'), 'testproject.testdataset.testtable')
        # leave project.dataset.table unchanged
        self.assertEqual(bq.resolve_ts('testproject.testdataset.testtable'), 'testproject.testdataset.testtable')
