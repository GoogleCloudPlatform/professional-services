...
This tool helps an organization better understand their bucket usage, across
all of their projects by computing aggregation statistics related to bucket
...
schema.json
````
<h3>2.4.4 Create the scheduled BigQuery job that computes access statistics</h3>
