...
public class BigQueryTableParser {
    ...
    private static Try<TableReference> parseFullTableId(String tableId) {
        ...
        return Try.success(buildTableReference(
    ...
    public static TableReference fromTable(Table table) {
        ...
        TableReference tableRef = buildTableReference(tableId.getProject(), tableId.getDataset(), tableId.getTable());
        return tableRef;
    }
    ...
    public static TableReference buildTableReference(String projectId, String datasetId, String tableId){
        TableReference tableReference = new TableReference();
