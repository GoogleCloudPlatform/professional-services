...
public class SpannerResourceProviderImplTest {
  ...
  @BeforeEach
  void init() {
    this.spannerResourceProvider = new SpannerResourceProviderImpl(spannerClient);
  }
  ...
  void testGetTables() {
    ...
    when(spannerClient.singleUse().executeQuery(any())).thenReturn(resultSetForExampleTable);
