...
/**
 * Provides utilities for validating ZetaSQL {@link ResolvedStatement}s resulting from running
 * the Analyzer using {@link ValidatingVisitor}s
 */
public class StatementValidator {
     ...
     * to each of them.
     *
     * <p> This method is specially helpful when used in conjunction with
     * {@link ZetaSQLToolkitAnalyzer#analyzeStatements(String, CatalogWrapper)}.
     *
