...
def module_under_test():
    from hive_to_bigquery import gcs_storage_component

    return gcs_storage_component


@pytest.fixture
def object_under_test(module_under_test):
    return module_under_test.GCSStorageComponent(PROJECT_ID)


def test_get_client(object_under_test, mock_storage_client):
