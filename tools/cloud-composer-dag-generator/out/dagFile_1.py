...
with DAG(
	...
	task_1 = BashOperator(task_id='task_1', bash_command="sleep 5s")

	task_2 = BashOperator(task_id='task_2', bash_command="echo 'command executed from BashOperator'")

	task_3 = BashOperator(task_id='task_3', bash_command="sleep 9s")
	...
	task_7 = BashOperator(task_id='task_7', bash_command="sleep 12s")

	task_8 = BashOperator(task_id='task_8', bash_command="echo 'command executed from BashOperator'")

	task_9 = BashOperator(task_id='task_9', bash_command="sleep 14s")

	task_10 = BashOperator(task_id='task_10', bash_command="echo 'command executed from BashOperator'")

	task_11 = BashOperator(task_id='task_11', bash_command="sleep 6s")

	task_12 = BashOperator(task_id='task_12', bash_command="echo 'command executed from BashOperator'")

	task_13 = BashOperator(task_id='task_13', bash_command="sleep 11s")

	chain(start_task,task_0,task_1,task_2,task_3,task_4,task_5,[task_13,task_12,task_11],task_6,task_7,task_8,task_9,task_10,stop_task)