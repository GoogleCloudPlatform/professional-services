...
* Custom IAM roles cannot be copied across projects due to security concerns. So if the source bucket has one applied to it and the user has chosen to copy over IAM policies, the tool will throw an error.
