...
from gcs_bucket_mover import bucket_mover_service, bucket_mover_test


def get_config():
    """Parses command line arguments and dispatches flow control to the appropriate subcommand
    handler.
...
def main():
    ...
    if config.test:
        bucket_mover_test.set_up_test_bucket(config)
