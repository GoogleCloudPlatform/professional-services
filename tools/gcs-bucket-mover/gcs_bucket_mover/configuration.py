...
class Configuration(object):
    ...
    def __init__(self, conf):
        """Load the values from config.sh into global variables and set up the credentials and
        storage clients.
    ...
    def __get_service_account_email(self, storage_client):  #Google guidelines differ from pylint. pylint: disable=no-self-use
        # Copied from an approved PR to https://github.com/GoogleCloudPlatform/google-cloud-python/blob/master/storage/google/cloud/storage/client.py pylint: disable=line-too-long
