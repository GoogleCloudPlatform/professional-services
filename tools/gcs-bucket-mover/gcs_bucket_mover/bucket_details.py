...
class BucketDetails(object):
    """Holds the details and settings of a bucket so that after the source bucket is deleted
    we can re-create it with all of the same details and settings.
    """
    ...
    def __init__(self, conf, source_bucket):
        ...
        Args:
            ...
            source_bucket: a google.cloud.storage.Bucket object
        """
    ...
    def set_skip_settings(self, conf):
