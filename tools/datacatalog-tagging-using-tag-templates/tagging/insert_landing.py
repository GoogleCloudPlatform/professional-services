...
def generate_hash(row):
   """Handles missing keys (fields) and generates MD5 hash"""
   fields = ["projectname", "datasetname", "tablename", "columnname", "level", "tagtemplate"]  # expected fields as primary
   str_values = [row.get(field, "") for field in fields]  # Get value or empty string if missing
