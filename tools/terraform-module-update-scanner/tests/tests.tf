...
module "from_github_over_https_latest_ref" {
  source = "github.com/hashicorp/terraform?ref=v0.12.0-alpha4"
}
...
module "from_github_over_ssh_latest_ref" {
  source = "git@github.com:hashicorp/terraform.git?ref=v0.12.0-alpha4"
}
...
module "bitbucket_https_latest_tag" {
...
module "from_github_over_https_latest_ref" {
  source = "git::https://github.com/hashicorp/terraform.git?ref=v0.12.0-alpha4"
}
