...
def create_migration_workflow(
    ...
    # Set the source dialect to Snowflake SQL.
    ...
    migration_task = bigquery_migration_v2.MigrationTask(
        type_="Translation_Snowflake2BQ", translation_config_details=translation_config
    )

    # Prepare the workflow.
    workflow = bigquery_migration_v2.MigrationWorkflow(
        display_name="Demo_Snowflake2BQ_Migration"
    )
...
# python3 snowflake_bq_converter.py <json_config_file_path> <project_name>
# eg) python3 snowflake_bq_converter.py gs://snowflake-ddl-extraction/sf-ddl-extraction-config.json poc-env-aks