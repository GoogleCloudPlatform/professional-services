...
gcloud storage buckets notifications create gs://$BUCKET_NAME --topic=projects/$PROJECT_ID/topics/tsop-transfer-logs-objects --object-prefix=storage-transfer/ --payload-format=json --event-types=OBJECT_FINALIZE
