...
import { Box, AppBar, Toolbar, Typography, Button, CssBaseline, ThemeProvider, Paper, IconButton } from '@mui/material'
            ...
            <OverlayProvider>
              <ModalProvider>
                ...
                <Box sx={{ 
                  ...
                  minHeight: '100vh', 
                  bgcolor: '#0f172a', // Dark slate background for the whole stage
                  gap: 2, 
                  p: { xs: 0, sm: 2 } 
                }}>
                <Box sx={{ 
                  ...
                  bgcolor: '#1e293b', // Slate Blue background for sidebar
                  borderRadius: 4,
                  overflow: 'hidden',
                  border: '1px solid rgba(255,255,255,0.1)',
                  opacity: 0.8 // Slightly de-emphasized
                }}>
                  <DemoSidebar />
                </Box>
                ...
                <Box sx={{
                  ...
                  p: { xs: 0, sm: '12px' }, // "Bezel" padding
                  bgcolor: { xs: 'transparent', sm: '#0f172a' }, // Bezel color (darker)
                  borderRadius: { xs: 0, sm: '48px' }, // Rounded bezel
