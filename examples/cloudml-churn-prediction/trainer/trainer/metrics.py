...
def get_class(predictions, threshold=0.50):
    ...
    Args:
         predictions: [None, # of bounded intervals] array containing conditional
                    likelihoods (model predictions)
         threshold: Float to compare predicted unconditional likelihoods against. The
                    predicted ordinal class is the first interval with likelihood under this
                    threshold. If all interval likelihoods are greater than this threshold,
                    the predicted class is the unbounded interval.
