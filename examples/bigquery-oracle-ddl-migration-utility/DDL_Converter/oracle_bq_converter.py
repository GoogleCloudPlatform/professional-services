...
def create_migration_workflow(
    ...
    # Set the source dialect to Oracle SQL.
    ...
    migration_task = bigquery_migration_v2.MigrationTask(
        type_="Translation_Oracle2BQ", translation_config_details=translation_config
    )

    # Prepare the workflow.
    workflow = bigquery_migration_v2.MigrationWorkflow(
        display_name="Demo_Oracle2BQ_Migration"
    )
...
# eg) python3 oracle_bq_converter.py
