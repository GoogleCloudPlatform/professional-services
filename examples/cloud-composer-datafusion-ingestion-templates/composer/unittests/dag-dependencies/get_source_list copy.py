...
# from dependencies.read_params import ReadParameters

sys.path.append('/Users/nehajo/projects/datalake-templates/composer/unittests')
sys.path.append('/Users/nehajo/projects/datalake-templates/composer/unittests/dag-dependencies')
from plugins.hooks.gcs_hook import GoogleCloudStorageHook
from plugins.hooks.custom_gcs_hook import GoogleCloudStorageCustomHook
from read_params import ReadParameters

print("current working directory (get_source_list.py):"+ os.getcwd())
class SourceList:
    """ This class has functions required to create
    inventory of files on GCS available for ingestion
    ...
    """
    def list_gcs_files(self, gcs_hook, bucket, prefix=None):
        """
        ...
        **context):
                            ...
                            if not file_name.endswith("/"):
                                task_entry["src_list"].append({
                                    "gcp_project_id.target_dataset": \
                                        f"{params.gcp_project_id}.{params.target_dataset}",
        ...
        if len(source_list)>0:
            ...
            src_list_abs_filename = GoogleCloudStorageCustomHook(
                ...
                filepath=f"/Users/nehajo/projects/datalake-templates/composer/unittests/data/{system}/{dag_run_id_det}/",
