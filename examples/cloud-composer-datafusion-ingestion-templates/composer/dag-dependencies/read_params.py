...
class ParamReader:
    """ParamReader class reads parameters from the 3 parameter files
    ...
    def read_parameters(self,system,dag_param_file_nm,task_param_file_nm):
        ...
        try:
            with open(dag_param_file_path) as dag_param_json:
                ...
                self.refresh_authorized_views = dag_param["refresh_authorized_views"] # pylint: disable=line-too-long
                    ...
                    if self.source_type == "gcs":
                        for obj in object_configs:
                            ...
                            if "gcs_src_file_path" in obj:
                                task_gcs_src_file_path = f'data/{obj["gcs_src_file_path"]}' # pylint: disable=line-too-long
                                logging.debug(
