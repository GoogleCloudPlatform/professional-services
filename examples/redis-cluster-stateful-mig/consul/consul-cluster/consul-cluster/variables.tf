...
variable "static_ip_address" {
  #@mandatory parameter
  description = "Internal static IP from var.subnetwork_name range, IP will be used for consul loadbalancer in consul-glb module."
  type = string
}

variable "static_ip_name" {
  description = "Name of the internal static IP"
  type = string
  default = "consul-demo-static-ip"
}