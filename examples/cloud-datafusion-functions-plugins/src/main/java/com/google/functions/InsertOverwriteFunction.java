...
/**
 * This class contains logic to copy tables from staging to destination at the end of the pipeline run.
 */
public class InsertOverwriteFunction {
    ...
    public InsertOverwriteFunction(String keyPath, String projectId, String dataSet, String tableName) {
    ...
    public void executeCopy() {
        try {
            ...
            CopyJobConfiguration queryConfig = CopyJobConfiguration.newBuilder(destinationTable, sourceTable)
