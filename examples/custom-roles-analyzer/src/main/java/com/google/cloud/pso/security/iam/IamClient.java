...
/**
 * IamClient class create the Iam service client and used to fetch predefined
 * roles, custom roles at org and project level.
 */
public class IamClient {
    ...
    private static Iam createIamService() throws IOException, GeneralSecurityException {
        ...
        if (iamService == null) {
            iamService = new Iam.Builder(httpTransport, gsonFactory, credential)
    ...
    public Set<Role> fetchPredefinedRoles() throws IOException, GeneralSecurityException {
        ...
        request.setView("1"); // Fetch all the details including pemissions. If not set permissions will not
                              // be fetched.
    ...
    /**
     * This method will fetch all the Custom roles in the organization/Project along
     * with permissions assoicated with it.
     * 
    ...
    /**
     * This method will fetch all the Custom roles in the project along
     * with permissions assoicated with it.
     * 
