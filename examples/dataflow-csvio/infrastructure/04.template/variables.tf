...
variable "jar_file_name" {
  type = string
  description = "The name of the built jar file from which the Dataflow job executes"
  default = "csvio-latest-all.jar"
}
...
variable "cloud_build_working_directory" {
  type        = string
  description = "The repository working directory within which to execute the Cloud Build job"
  default     = "examples/dataflow-csvio"
}